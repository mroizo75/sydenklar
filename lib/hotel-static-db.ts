...
const ISO_TO_COUNTRY: Record<string, string> = {
  AD:'Andorra',AE:'De forente arabiske emirater',AF:'Afghanistan',AG:'Antigua og Barbuda',
  AL:'Albania',AM:'Armenia',AO:'Angola',AR:'Argentina',AT:'Østerrike',AU:'Australia',
  AZ:'Aserbajdsjan',BA:'Bosnia-Hercegovina',BB:'Barbados',BD:'Bangladesh',BE:'Belgia',
  BF:'Burkina Faso',BG:'Bulgaria',BH:'Bahrain',BJ:'Benin',BN:'Brunei',BO:'Bolivia',
  BR:'Brasil',BS:'Bahamas',BT:'Bhutan',BW:'Botswana',BY:'Hviterussland',BZ:'Belize',
  CA:'Canada',CD:'Kongo',CF:'Den sentralafrikanske republikk',CG:'Kongo-Brazzaville',
  CH:'Sveits',CI:'Elfenbenskysten',CL:'Chile',CM:'Kamerun',CN:'Kina',CO:'Colombia',
  CR:'Costa Rica',CU:'Cuba',CV:'Kapp Verde',CY:'Kypros',CZ:'Tsjekkia',DE:'Tyskland',
  DJ:'Djibouti',DK:'Danmark',DM:'Dominica',DO:'Den dominikanske republikk',DZ:'Algerie',
  EC:'Ecuador',EE:'Estland',EG:'Egypt',ER:'Eritrea',ES:'Spania',ET:'Etiopia',FI:'Finland',
  FJ:'Fiji',FR:'Frankrike',GA:'Gabon',GB:'Storbritannia',GD:'Grenada',GE:'Georgia',
  GH:'Ghana',GL:'Grønland',GM:'Gambia',GN:'Guinea',GQ:'Ekvatorial-Guinea',GR:'Hellas',
  GT:'Guatemala',GW:'Guinea-Bissau',GY:'Guyana',HN:'Honduras',HR:'Kroatia',HT:'Haiti',
  HU:'Ungarn',ID:'Indonesia',IE:'Irland',IL:'Israel',IN:'India',IQ:'Irak',IR:'Iran',
  IS:'Island',IT:'Italia',JM:'Jamaica',JO:'Jordan',JP:'Japan',KE:'Kenya',KG:'Kirgisistan',
  KH:'Kambodsja',KI:'Kiribati',KM:'Komorene',KN:'Saint Kitts og Nevis',KP:'Nord-Korea',
  KR:'Sør-Korea',KW:'Kuwait',KZ:'Kasakhstan',LA:'Laos',LB:'Libanon',LC:'Saint Lucia',
  LI:'Liechtenstein',LK:'Sri Lanka',LR:'Liberia',LS:'Lesotho',LT:'Litauen',LU:'Luxemburg',
  LV:'Latvia',LY:'Libya',MA:'Marokko',MC:'Monaco',MD:'Moldova',ME:'Montenegro',
  MG:'Madagaskar',MK:'Nord-Makedonia',ML:'Mali',MM:'Myanmar',MN:'Mongolia',MR:'Mauritania',
  MT:'Malta',MU:'Mauritius',MV:'Maldivene',MW:'Malawi',MX:'Mexico',MY:'Malaysia',
  MZ:'Mosambik',NA:'Namibia',NE:'Niger',NG:'Nigeria',NI:'Nicaragua',NL:'Nederland',
  NO:'Norge',NP:'Nepal',NR:'Nauru',NZ:'New Zealand',OM:'Oman',PA:'Panama',PE:'Peru',
  PG:'Papua Ny-Guinea',PH:'Filippinene',PK:'Pakistan',PL:'Polen',PT:'Portugal',PW:'Palau',
  PY:'Paraguay',QA:'Qatar',RO:'Romania',RS:'Serbia',RU:'Russland',RW:'Rwanda',
  SA:'Saudi-Arabia',SB:'Salomonøyene',SC:'Seychellene',SD:'Sudan',SE:'Sverige',
  SG:'Singapore',SI:'Slovenia',SK:'Slovakia',SL:'Sierra Leone',SM:'San Marino',
  SN:'Senegal',SO:'Somalia',SR:'Surinam',SS:'Sør-Sudan',ST:'Sao Tome og Principe',
  SV:'El Salvador',SY:'Syria',SZ:'Eswatini',TD:'Tsjad',TG:'Togo',TH:'Thailand',
  TJ:'Tadsjikistan',TL:'Øst-Timor',TM:'Turkmenistan',TN:'Tunisia',TO:'Tonga',
  TR:'Tyrkia',TT:'Trinidad og Tobago',TV:'Tuvalu',TZ:'Tanzania',UA:'Ukraina',
  UG:'Uganda',US:'USA',UY:'Uruguay',UZ:'Usbekistan',VA:'Vatikanstaten',
  VC:'Saint Vincent og Grenadinene',VE:'Venezuela',VN:'Vietnam',VU:'Vanuatu',
  WS:'Samoa',YE:'Jemen',ZA:'Sør-Afrika',ZM:'Zambia',ZW:'Zimbabwe',
}

export function isoToCountryName(code: string): string | undefined {
  return ISO_TO_COUNTRY[code?.toUpperCase()]
}
...
export function rawApiToRecord(raw: any): HotelStaticRecord | null {
  ...
  return {
    ...
    city_name: raw.city?.name ?? raw.region?.name ?? undefined,
    region_name: raw.region?.name ?? undefined,
    country_name: raw.region?.country_name ?? raw.country?.name ?? isoToCountryName(raw.region?.country_code) ?? raw.region?.country_code ?? undefined,
